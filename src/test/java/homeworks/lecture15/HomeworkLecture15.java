...
public class HomeworkLecture15 {
    ...
    public void testBasicAuthentication() {
        ...
        //Not sure why test fails, I used the same alert as used in the examples from the lecture but I get NoAlertPresentException: no such alert - some
        //remarks will be helpful here
    }

    @Test
    public void testCheckBoxes() {
        driver.get("https://the-internet.herokuapp.com/");
        WebElement checkboxesLink = driver.findElement(By.xpath("//*[contains(text(),'Checkboxes')]"));
    ...
    @Test
    public void testDisappearingElementsHome() {
        driver.get("https://the-internet.herokuapp.com/");
    ...
    @Test
    public void testDisappearingElementsAbout() {
        driver.get("https://the-internet.herokuapp.com/");
        WebElement disappearingElementsLink = driver.findElement(By.xpath("//*[contains(text(),'Disappearing Elements')]"));
        disappearingElementsLink.click();
    ...
    @Test
    public void testDisappearingElementsContactUs() {
        driver.get("https://the-internet.herokuapp.com/");
        WebElement disappearingElementsLink = driver.findElement(By.xpath("//*[contains(text(),'Disappearing Elements')]"));
        disappearingElementsLink.click();
    ...
    @Test
    public void testDisappearingElementsPortfolio() {
        driver.get("https://the-internet.herokuapp.com/");
        WebElement disappearingElementsLink = driver.findElement(By.xpath("//*[contains(text(),'Disappearing Elements')]"));
        disappearingElementsLink.click();
    ...
    @Test
    public void testDisappearingElementsGallery() {
        driver.get("https://the-internet.herokuapp.com/");
        WebElement disappearingElementsLink = driver.findElement(By.xpath("//*[contains(text(),'Disappearing Elements')]"));
        disappearingElementsLink.click();
        ...
        galleryButton.click();
        wait.until(ExpectedConditions.urlToBe("https://the-internet.herokuapp.com/gallery/"));
    ...
    public void testDropDown() {
        ...
        Select dropdownpSelectAnOption = new Select(driver.findElement(By.id("dropdown")));
        dropdownpSelectAnOption.selectByVisibleText("Option 1");
        dropdownpSelectAnOption.selectByIndex(2);
        dropdownpSelectAnOption.selectByIndex(1);
        dropdownpSelectAnOption.selectByIndex(2);


        //Not sure how I should be using assertions here in order to validate that I have selected the correct one
        //I saw it has some selected="selected" class but not sure how I can use it
        //I also found ExpectedConditions.elementSelectionStateToBe() function but I need to use WebElement and I couldn't figure how to refactor my code
        //in order to achieve this. Any remarks will be helpful here
    ...
    public void testDynamicContent() {
        ...
        wait.until(ExpectedConditions.urlToBe("https://the-internet.herokuapp.com/dynamic_content?with_content=static"));
        wait.until(ExpectedConditions.visibilityOf(dynamicContentTitle));
        Assert.assertEquals(actualText1, expectedText1);
        Assert.assertEquals(actualText2, expectedText2);

        WebElement picture1 = driver.findElement(By.linkText("/img/avatars/Original-Facebook-Geek-Profile-Avatar-6.jpg"));
        Assert.assertTrue(picture1.isDisplayed());

        WebElement picture2 = driver.findElement(By.linkText("/img/avatars/Original-Facebook-Geek-Profile-Avatar-3.jpg"));
        Assert.assertTrue(picture2.isDisplayed());

        WebElement picture3 = driver.findElement(By.linkText("/img/avatars/Original-Facebook-Geek-Profile-Avatar-7.jpg"));
